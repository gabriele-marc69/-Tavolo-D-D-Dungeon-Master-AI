...
def map_reminder(state: dict | None = None) -> str:
    ...
    return (
        ...
        "MAP_START…MAP_END (oppure <MAP>…</MAP>): il riquadro mappa lo "
        "RIDISEGNA DA ZERO ogni turno usando ESATTAMENTE quello che "
        "scrivi, con le STESSE dimensioni che gli dai (puoi cambiarle a "
        "ogni messaggio se la scena lo richiede — niente è bloccato).\n"
